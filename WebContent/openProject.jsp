	...
	<!-- main content start-->
		<div id="page-wrapper">
			...
			<%try{
				...
				PreparedStatement ps1 = con.prepareStatement("select department from deptdetails");
			...
			<div class="form-group">
		 <div><label for="selector1" class="col-sm-2 control-label">Add Responsible Employees:-</label></div>
			<div class="col-sm-8"><select name="rsemp" id="selector1" class="form-control1" >
						
			<%try{
				Connection con = ConnectsDB.getConnect();
				PreparedStatement ps2 = con.prepareStatement("select empemail from empdetails");
				ResultSet rst = ps2.executeQuery();
				while(rst.next()){
				%>
				<option><%=rst.getString("empemail")%></option>
				<%
				}
				}catch(Exception e)
				{
			...
			<div class="form-group">
						 <div><label for="selector1" class="col-sm-2 control-label">Add Task to Department:-</label></div>
			
			<div class="col-sm-8"><select name="tsdpt" id="selector1" class="form-control1" >
						
			<%try{
				Connection con = ConnectsDB.getConnect();
				PreparedStatement ps2 = con.prepareStatement("select title from task");
				ResultSet rst = ps2.executeQuery();
				while(rst.next()){
				%>
				<option><%=rst.getString("title")%></option>
				<%
				}
				}catch(Exception e)
				{
			...
			<div class="form-group">
						 <div><label for="selector1" class="col-sm-2 control-label">Add task to  Employees:-</label></div>
			
			<div class="col-sm-8"><select name="tsemp" id="selector1" class="form-control1" >
