	...
	<!-- main content start-->
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div>
					<h2 class="title1">Departments :- </h2>
				</div>
			...
			<%try{
				...
				PreparedStatement ps1 = con.prepareStatement("select * from deptdetails");
				...
				<tr>
					...
					<td><a href="deleteDepartment.jsp?id=<%=rs.getInt("vid")%>">Delete</a></td>	
				</tr>
					<%
					}
					}catch(Exception e)
