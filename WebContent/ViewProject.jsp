            ...
            <ul class="sidebar-menu">
              <li class="header">MAIN NAVIGATION</li>
				...
				<li><a href="AddEmployee.html"><i class="fa fa-angle-right"></i> Add Employee</a></li>
                  <li><a href="DelEmployee.html"><i class="fa fa-angle-right"></i> Delete Employee</a></li>
                ...
                <li><a href="DelDepartment.html"><i class="fa fa-angle-right"></i> Delete Department</a></li>
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
 				 ...
 				 <li><a href="media.html"><i class="fa fa-angle-right"></i> Create New Projects</a></li>
                 <li><a href="media.html"><i class="fa fa-angle-right"></i> Edit Project</a></li>
                 <li><a href="media.html"><i class="fa fa-angle-right"></i> Delete Project</a></li>
                 <li><a href="grids.html"><i class="fa fa-angle-right"></i> View Projects</a></li>
