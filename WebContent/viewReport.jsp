	...
	<!-- main content start-->
		<div id="page-wrapper">
			...
			<%try{
				...
				PreparedStatement ps1 = con.prepareStatement("select * from report where pid = ?");
				ps1.setInt(1, pid);
				...
				<tr>
					...
					<td><%=rs.getString("weatherimpact") %></td>
					<td><%=rs.getString("accident") %></td>
					<td><%=rs.getString("injuries") %></td>
					<td><%=rs.getString("wrkdone") %></td>
					<td><%=rs.getString("equipmentused") %></td>
					<td><%=rs.getString("materialdelivery") %></td>
					<td><%=rs.getString("materialquantity") %></td>
