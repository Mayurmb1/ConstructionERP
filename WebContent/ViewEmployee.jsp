	...
	<!-- main content start-->
		<div id="page-wrapper">
			...
			<%try{
				...
				PreparedStatement ps1 = con.prepareStatement("select * from empdetails");
				...
				<tr>
					...
					<td><%=rs.getString("empemrgcontact") %></td>
					<td><%=rs.getString("empdepartment") %></td>	
					<td><a href="deleteEmployee.jsp?id=<%=rs.getInt("empid")%>">Delete</a></td>	
				</tr>
					<%
					}
					}catch(Exception e)
